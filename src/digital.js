    ...
    <div>
      <div className="portfolio-row">
        <div className="portfolio-content image-content">
          <img src={process.env.PUBLIC_URL + "/portfolio/autumn-girl.png"} />
        </div>
        <div className="portfolio-content image-content">
          <img
            src={process.env.PUBLIC_URL + "/portfolio/japanese-circle.png"}
          />
        </div>
      </div>
      <div className="portfolio-row">
        <div className="portfolio-content image-content">
          <img src={process.env.PUBLIC_URL + "/portfolio/lobster.png"} />
        </div>
        <div className="portfolio-content image-content">
          <img
            src={process.env.PUBLIC_URL + "/portfolio/mechanical-bully.png"}
          />
        </div>
      </div>
      <div className="portfolio-row">
        <div className="portfolio-content image-content">
          <img src={process.env.PUBLIC_URL + "/portfolio/multi-girls.png"} />
        </div>
        <div className="portfolio-content image-content">
          <img
            src={process.env.PUBLIC_URL + "/portfolio/shrimp-cocktail.png"}
          />
        </div>
      </div>
      <div className="portfolio-row">
        ...
        <div className="portfolio-content image-content">
          <img src={process.env.PUBLIC_URL + "/portfolio/women-print.png"} />
        </div>
      </div>
      <div className="portfolio-row">
        <div className="portfolio-content image-content">
